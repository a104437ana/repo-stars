...
export function renderStarsTextSVG({ count }) {
  ...
  <text x="${padX}" y="${height - 5}" font-family="${FONT_FAMILY}" font-weight="700" font-size="${fontSize}"
    fill="${FILL}" stroke="${STROKE}" stroke-width="1" stroke-opacity="0.55" paint-order="stroke fill">${label}</text>
</svg>
`;
}
